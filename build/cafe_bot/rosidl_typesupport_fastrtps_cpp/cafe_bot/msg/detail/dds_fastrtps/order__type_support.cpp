...
#include "cafe_bot/msg/detail/order__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cafe_bot::msg::Order;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cafe_bot::msg::Order *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cafe_bot::msg::Order *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_cafe_bot
const rosidl_message_type_support_t *
get_message_type_support_handle<cafe_bot::msg::Order>()
{
  return &cafe_bot::msg::typesupport_fastrtps_cpp::_Order__handle;
}
