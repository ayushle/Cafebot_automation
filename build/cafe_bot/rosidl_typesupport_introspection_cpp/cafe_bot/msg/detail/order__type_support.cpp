...
{
  new (message_memory) cafe_bot::msg::Order(_init);
}

void Order_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cafe_bot::msg::Order *>(message_memory);
  typed_message->~Order();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Order_message_member_array[2] = {
  {
    ...
    offsetof(cafe_bot::msg::Order, table),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cafe_bot::msg::Order, item),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Order_message_members = {
  "cafe_bot::msg",  // message namespace
  "Order",  // message name
  2,  // number of fields
  sizeof(cafe_bot::msg::Order),
...
{
  return &::cafe_bot::msg::rosidl_typesupport_introspection_cpp::Order_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cafe_bot, msg, Order)() {
  return &::cafe_bot::msg::rosidl_typesupport_introspection_cpp::Order_message_type_support_handle;
}
